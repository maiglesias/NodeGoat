...
variable "practices_dynamodb_table_arn" {
  type        = string
  description = "ARN of practices dynamodb table"
}

variable "practices_dynamodb_table_name" {
  type        = string
  description = "Name of practices dynamodb table"
}
